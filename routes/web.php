...
Route::controller(App\Http\Controllers\UserController::class)->group(function () {
    Route::prefix('home')->group(function () {
        ...
        Route::get('/edit', 'edit')->name('home.edit');
        Route::put('/update/{user}', 'update')->name('home.update');
    });
});
...
Route::get('track/get-track', [App\Http\Controllers\BookController::class, 'getTrackBook'])->name('track.gettrack');


Route::prefix('payment')->group(function () {
    Route::get('/success/{book}', [App\Http\Controllers\BookController::class, 'paymentSuccess'])->name('payment.success');
    Route::get('/cancel/{book}', [App\Http\Controllers\BookController::class, 'paymentCancel'])->name('payment.cancel');
