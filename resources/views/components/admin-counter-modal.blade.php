<div id="counter-popup-modal" tabindex="-1"
    ...
    <div class="relative w-full h-full max-w-md md:h-auto">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 text-center">
                <form action="{{ route('admin.counter-verify', 0) }}" method="POST" id="form-admin-counter-verify-id">
                    @csrf
                    @method('PUT')
                    ...
                    <button data-modal-toggle="counter-popup-modal" type="submit"
                    ...
                    <button data-modal-toggle="counter-popup-modal" type="button"
