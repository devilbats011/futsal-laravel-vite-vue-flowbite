        <nav class="flex flex-col md:flex-row items-center justify-start gap-y-1 pb-2">
            {{-- <a  class="px-4">  </a> --}}
            <a href="/"
            ...
            @guest
                ...
                <a href="{{ route('register') }}" class="pl-2 lg:pr-4"> Register </a>
            @endguest
            @auth
                ...
                <a href="{{ route('home') }}" class="px-4 ">  Profile </a>
                <a href="{{ route('home.edit') }}" class="px-4"> Edit Profile </a>
